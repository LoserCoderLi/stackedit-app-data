...
#### 注意事项
**向上转型（父类类型  引用名 = new 子类类型（）），可以调用父类所有成员，不能调用子类的特有成员，相同名字的成员用子类的内容**
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3ODQ1NDEyOTcsLTE4MjE0ODkwOTEsMT
c1NDU4MzEzOCwtMzE2NjYyNjM5LDM0MzQ2ODkwOSwyMzk5MTQ4
OCwtNDU4OTMwMjYsMTA0NjQyODcxMiwxMjExNTgzNjI1LDEyNz
U1NjgyNzQsLTIwNDU2MzI5OTYsLTE3MzM4NTY4NTQsNjIzMjMx
NjY3LDE3NjY2OTEwMDcsLTUwNjMwMjY2MiwxODU3MTc1MjczLC
0xNTkzNzA1MTEyLC0xOTYzMjQxMjQ2LDE4NDMyOTYxMzYsMTcy
OTAzMTU2Nl19
-->