...
## 实例
![输入图片说明](/imgs/2024-07-15/Dkc5KceZj67hw7RV.png)

**直接静态初始化对象**

**在调用getInstance时候，先判断是不是为null，如果为空初始化对象，然后返回类变量**
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTUxMTUyMDQ5OCw1MTQ0OTYxMzksLTEzMj
MxMzcxODAsLTc3NzAyOTY0MiwtMTAyNTEyNTYxMSwtNTg5MDQ2
OTIyLDE3NjIzNTYxNzUsMjA4MjgyMzA5LDE4OTM4NTgzMTAsMj
AwODM4NzY5NywtMjAyODcwMTExXX0=
-->