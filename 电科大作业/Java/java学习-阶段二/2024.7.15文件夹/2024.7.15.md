...
**static>普通；初始化和代码块>构造器；父类静态>子类静态>父类普通>子类pu't；同为static时，先定义先被调用；同为普通时，先定义先被调用**



<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwODc3OTc3MzAsLTc3NzAyOTY0MiwtMT
AyNTEyNTYxMSwtNTg5MDQ2OTIyLDE3NjIzNTYxNzUsMjA4Mjgy
MzA5LDE4OTM4NTgzMTAsMjAwODM4NzY5NywtMjAyODcwMTExXX
0=
-->