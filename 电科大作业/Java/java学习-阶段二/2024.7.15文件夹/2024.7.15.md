...
**static>普通；同为static时，先定义先被调用；同为普通时，先定义先被调用**



<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5MzIwMzY5LC03NzcwMjk2NDIsLTEwMj
UxMjU2MTEsLTU4OTA0NjkyMiwxNzYyMzU2MTc1LDIwODI4MjMw
OSwxODkzODU4MzEwLDIwMDgzODc2OTcsLTIwMjg3MDExMV19
-->